...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `Você é um gestor de tráfego pago especialista. Sua tarefa é transformar o conteúdo de um anúncio gerado pelo Método ANDROMEDA em uma estrutura JSON organizada que simula um gerenciador de anúncios real.
      ...
      "ads": [
        {
          ...
          "video_script": "Resumo do roteiro se for vídeo",
